...
EFI_STATUS efi_main(EFI_HANDLE ImageHandle, EFI_SYSTEM_TABLE *SystemTable)
{
	...
	{
		Print(L"Kernel is borked\n\r");
	}
	else
	{
		Print(L"Kernel is pristine and verified\n\r");
	}
	...
	Print(L"Kernel loading complete.\n\r");
	...
	if (newFont == NULL) {
		...
		Print(L"Font found. Char size is %d\n\r", newFont->psf1_Header->charsize);
	}
